...
def crop_resize_data(image, label=None, image_size=(512, 192), offset=690):
    """
    Attention:
    h,w, c = image.shape
...
class LaneDataset(Dataset):
    ...
    def __getitem__(self, idx):
        pd.DataFrame(self.images).to_csv('C:/Users/Yan/Desktop/项目1/car_lane_detection/logs/image.csv', index = True)
        print(idx)
