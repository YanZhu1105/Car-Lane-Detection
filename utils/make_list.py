...
image_dir = Path('D:/Data/baidu/Image_Data/')
label_dir = Path('D:/Data/baidu/Label/')
save_path = Path('C:/Users/Yan/Desktop/项目1/car_lane_detection/data_list/')
...
train_dataset.to_csv(save_path.joinpath('train.csv'), index=False)
val_dataset.to_csv(save_path.joinpath('val.csv'), index=False)
test_dataset.to_csv(save_path.joinpath('test.csv'), index=False)
